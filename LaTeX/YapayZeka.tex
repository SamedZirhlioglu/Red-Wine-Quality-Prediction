...
\begin{figure}[!h]
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.4]{pictures/pic_08.png}&
		\end{tabular}
	\end{center}
...
\begin{figure}[!h]
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.4]{pictures/pic_09.png}&
		\end{tabular}
	\end{center}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|c|}
		...
		\textbf{LG}		& 0.76		& 0.26		& 0.736		\\ \hline
...
\begin{figure}[!h]
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.2]{pictures/pic_20.png}&
		\end{tabular}
	\end{center}
	\caption{Bagging Hata Matrisi}
	\label{fig:20}
